...
USE `stick`;
INSERT INTO `productos`(user_id, nombre, descripcion) 
...
USE `stick`;
INSERT INTO `productos`(user_id, nombre, descripcion) 
VALUES (7,"Tartaneras addidas","Es un botín clásico, tradicional en su perfil de cosmética, ampliamente testeado en calidad y duración. Está realizado en materiales sintéticos sin costuras y con detalles de alta frecuencia, lo que hace liviano y cómodo.")
